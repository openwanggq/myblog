...
import com.wpy.mapper.ArticleMapper;
import com.wpy.mapper.TagsMapper;
...
public class ArticleService {
    ...
    public List<Article> getArticles(Integer page, Integer count, String keywords) {
        int start = (page - 1) * count;
        return articleMapper.getArticles(start, count, keywords);
    }
